...
public class AssetCatalogTests : IDisposable
{
    ...
    public void BuildAssetsReturnsOneAssetPerSizeEntry()
    {
        ...
        var toc = new TocData
        {
            Archives = [new SpiderManModdingTool.Core.Sections.ArchivesMapSection { Name = "Archive0" }],
            AssetIds = [0x1111UL, 0x1111UL],
            SizeEntries =
            [
                new SpiderManModdingTool.Core.Sections.SizeEntriesSection { Always1 = 1, Value = 100, Index = 0 },
                new SpiderManModdingTool.Core.Sections.SizeEntriesSection { Always1 = 1, Value = 200, Index = 1 }
            ],
            Offsets =
            [
                new SpiderManModdingTool.Core.Sections.OffsetsSection { ArchiveIndex = 0, OffsetInArchive = 10 },
                new SpiderManModdingTool.Core.Sections.OffsetsSection { ArchiveIndex = 0, OffsetInArchive = 20 }
            ]
        };
    ...
    public void BuildAssetsJoinsOffsetsBySizeEntryPosition()
    {
        ...
        var toc = new TocData
        {
            ...
            SizeEntries =
            [
                new SpiderManModdingTool.Core.Sections.SizeEntriesSection { Always1 = 1, Value = 100, Index = 1 },
                new SpiderManModdingTool.Core.Sections.SizeEntriesSection { Always1 = 1, Value = 200, Index = 0 }
            ],
            Offsets =
            [
                new SpiderManModdingTool.Core.Sections.OffsetsSection { ArchiveIndex = 0, OffsetInArchive = 10 },
    ...
    public void BuildAssetsThrowsWhenAssetIdIndexIsOutOfRange()
    {
        ...
        var toc = new TocData
        {
            Archives = [new SpiderManModdingTool.Core.Sections.ArchivesMapSection { Name = "Archive0" }],
            AssetIds = [0x1111UL],
            SizeEntries = [new SpiderManModdingTool.Core.Sections.SizeEntriesSection { Value = 100, Index = 5 }],
            Offsets = [new SpiderManModdingTool.Core.Sections.OffsetsSection { ArchiveIndex = 0, OffsetInArchive = 10 }]
        };
    ...
    public void BuildAssetsThrowsWhenOffsetIsMissing()
    {
        ...
        var toc = new TocData
        {
            Archives = [new SpiderManModdingTool.Core.Sections.ArchivesMapSection { Name = "Archive0" }],
            AssetIds = [0x1111UL],
            SizeEntries = [new SpiderManModdingTool.Core.Sections.SizeEntriesSection { Value = 100, Index = 0 }]
        };
    ...
    public void BuildAssetsThrowsWhenArchiveIndexIsOutOfRange()
    {
        ...
        var toc = new TocData
        {
            ...
            AssetIds = [0x1111UL],
            SizeEntries = [new SpiderManModdingTool.Core.Sections.SizeEntriesSection { Value = 100, Index = 0 }],
            Offsets = [new SpiderManModdingTool.Core.Sections.OffsetsSection { ArchiveIndex = 3, OffsetInArchive = 10 }]
        };
