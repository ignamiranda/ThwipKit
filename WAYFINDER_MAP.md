...
- [Command-line interface](.scratch/spider-man-modding-tool/issues/06-commandline-interface.md) — Created ThwipKit.CLI console app with extract, rebuild, list, backup, restore, version, and help commands; shares Core library with GUI; auto-detects game path or uses SPIDERMAN_GAME_PATH env var
